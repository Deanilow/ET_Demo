 ...
 *   https://datatables.net/download/#dt/dt-1.10.16/rg-1.0.2/sl-1.2.4
 *
 * Included libraries:
 *  DataTables 1.10.16, RowGroup 1.0.2, Select 1.2.4
 */
...
(function (factory) {
    ...
    (function ($, window, document, undefined) {
        ...
        */
         ...
         * @returns {DataTables.Api} this
         */
        _api_register('ajax.reloadTable()', function (callback, resetPaging) {
            return this.iterator('table', function (settings) {
        ...
        */
         ...
         * has the same effect as calling `ajax.reloadTable()` but is provided for
         * convenience when setting a new URL. Like `ajax.reloadTable()` it will
        ...
        */
        ...
        DataTable.ext = _ext = {
             ...
             *  @type string
             */
            builder: "dt/dt-1.10.16/rg-1.0.2/sl-1.2.4",
